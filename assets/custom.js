...
x.innerHTML += "This is a mirrored copy of the <a href='https://myride.mhtransit.ca/'>original website</a> with HTTPS working. The certificate on the original website has not been renewed for " + elapsedHours + ". It is not the official site.";
